...
<body bgcolor=#FFFFFF text=#000000 leftmargin=0 topmargin=0
	...
	<br>
	<form name="f" method="post" action="basket_list.m2">
		<input type="hidden" name="command" value="basketInsert">
		<table style="width: 100%">
			<tr>
				...
				<table style="width: 100%">
					<tr>
						<td align="right"><input type="submit" value="장바구니에 추가" class="button"/></td>
					</tr>
				</table>
			...
			<tr>
				...
				<td>
					...
					<table style="width: 100%">
						<tr>
							<td bgcolor="f4f4f4" height="22">&nbsp;&nbsp;<b>장바구니에 추가</b></td>
						</tr>
					</table> <br> <!-- list -->
					<table style="width: 80%; background-color: Black" align="center">
						<tr>
							<td width="30" align="center" bgcolor="E6ECDE" style="background-color: #ffda44"
							>추가</td>
							<td width="190" align="center" bgcolor="E6ECDE"  style="background-color: #ffda44"
							height="22">물품ID</td>
							<td width="200" align="center" bgcolor="E6ECDE" style="background-color: #ffda44"
							>물품명</td>
							<td width="200" align="center" bgcolor="E6ECDE" style="background-color: #ffda44"
							>가격</td>
							<td width="200" align="center" bgcolor="E6ECDE" style="background-color: #ffda44"
						...
						<tr>
							<td width="30" align="center" bgcolor="ffffff" height="20">
								<input type="checkbox" name="basket_add" value="<%=product.getProduct_id() %>">
							</td>
							<td width="190" align="center" bgcolor="ffffff" height="20">
								<%=product.getProduct_id()%>
							</td>
							<td width="200" bgcolor="ffffff" style="padding-left: 10"><a
								href="product_view.m2?product_id=<%=product.getProduct_id()%>&command=basketProductView"
