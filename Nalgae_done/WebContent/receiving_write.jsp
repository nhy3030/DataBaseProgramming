...
function receivingAdd() {
	f.command.value = "receivingAdd";
	f.action = "receiving_add.m2";
	f.submit();
}
</script>
</head>
...
<input type="hidden" name="command" value="receivingInsert">
<table style="width: 100%">
  <tr>
	...
	<table style="width: 100%">
		<tr>
			<td align="right"><input type="submit" value="입고품에 추가" class="button"/></td>
		</tr>
	</table>
  ...
  <tr>
		...
		<td><input type="button" value="검색" onClick="productListSearchByCategory()"></td>
	  </tr>
    <tr><td>&nbsp;</td><td>&nbsp;</td></tr>
  ...
  <tr>
	...
	<td>
	  ...
	  <table style="width:100%">
		<tr>
			<td bgcolor="f4f4f4" height="22">&nbsp;&nbsp;<b>입고품에 추가</b></td>
		</tr>
	  </table>  
	  <br>	
...
%>		  	
		<tr>
			<td width="30" align="center" bgcolor="ffffff" height="20">
				<input type="checkbox" name="receiving_add" value="<%=product.getProduct_id() %>">
			</td>
			<td width="190" align="center" bgcolor="ffffff" height="20">
				<%= product.getProduct_id() %>
			</td>
			<td width="200" bgcolor="ffffff" style="padding-left: 10">
				<a href="product_view.m2?product_id=<%= product.getProduct_id() %>&command=productView" class="product">
			...
			<!--
			<td width="190" align="center" bgcolor="ffffff" height="20">
				<a href="receiving_add.m2?product_id=<%= product.getProduct_id() %>&command=receivingAdd" class="product">
					추가하기
				</a>
			</td>
			-->
