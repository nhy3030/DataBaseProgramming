  ...
  <table style="width: 100%">
    <tr>
	  ...
	  <td>
	    ...
	    <table style="width: 100%">
		  <tr>
			<td bgcolor="f4f4f4" height="22">&nbsp;&nbsp;<b>입고 물품 정보보기</b></td>
		  </tr>
	    </table>  
	    <br>	  
	  	...
	  	<table style="width: 100%; background-color: YellowGreen">
	  	  <tr>
			<td width="120" align="center" bgcolor="E6ECDE" height="22">물품ID</td>
			<td width="470" bgcolor="ffffff" style="padding-left: 10">
				<%= product.getProduct_id() %>
			</td>
		  </tr>
		  <tr>
			<td width="120" align="center" bgcolor="E6ECDE" height="22">물품명</td>
			<td width="470" bgcolor="ffffff" style="padding-left: 10">
				<%= product.getProduct_name() %>
			</td>
		  </tr>		  
		  <tr>
			<td width="120" align="center" bgcolor="E6ECDE" height="22">물품가격</td>
			<td width="470" bgcolor="ffffff" style="padding-left: 10">
				<%= product.getProduct_price() %>
			</td>
		  </tr>	
		  <tr>
			<td width="120" align="center" bgcolor="E6ECDE" height="22">좋아요 개수</td>
			<td width="470" bgcolor="ffffff" style="padding-left: 10">
				<%= product.getScore() %>
			</td>
		  </tr>
