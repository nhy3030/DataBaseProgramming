	...
	<form name="f" method="post" action="product_write.m2">
		...
		<table style="width: 100%">
			...
			<tr>
				...
				<td>
					<!--contents-->
					<!-- select p.product_id, count(*), p.product_name, p.product_price, c.category_name, p.score -->
					<table style="width: 100%">
						<tr>
					...
					<table style="width: 100%; background-color: Black">
						<tr>
							...
							<td width="200" align="center" bgcolor="E6ECDE" style="background-color: #ffda44">물품가격</td>
							<td width="200" align="center" bgcolor="E6ECDE" style="background-color: #ffda44">카테고리명</td>
							<td width="200" align="center" bgcolor="E6ECDE" style="background-color: #ffda44">좋아요수</td>
							<td width="200" align="center" bgcolor="E6ECDE" style="background-color: #ffda44"><b>찜한 횟수</b></td>
						</tr>
						<%
							if (productList != null) {
