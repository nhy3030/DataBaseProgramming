...
<html>
<head>
<title>장바구니에 넣기</title>
<meta http-equiv="Content-Type" content="text/html; charset=euc-kr">
<link rel=stylesheet href="user.css" type="text/css">
<script>
function productList() {
	f.command.value = "recommendList";
	f.action = "recommend_list.m2";
	f.submit();
}
...
function basketAddOnlyOne() {
	if( confirm ("장바구니에 추가하시겠습니까??") ) {
		f.command.value = "basketAddOnlyOne";
		f.action = "basketAddOnlyOne.m2";
		f.submit();
	}
}
  ...
  <table style="width: 100%">
    <tr>
	  ...
	  <td>
	    ...
	    <table style="width: 100%">
		  <tr>
			<td bgcolor="f4f4f4" height="22">&nbsp;&nbsp;<b>물품 정보보기</b></td>
		  </tr>
	    </table>  
	    <br>	  
	    ...
	    <br>
 	    ...
 	    <table style="width: 100%">
		  <tr align="center">
			...
			<td align="left">
				<input type="button" value="장바구니에 추가" onClick="basketAddOnlyOne()"> 
			</td>
		  </tr>
	    </table>
	  </td>
