...
import model.mnginfo.MnginfoManager;


public class MlistAction implements Action {
	public ActionForward execute(HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		try {
			//모델에 로그인 처리를 위임.
			MnginfoManager manager = MnginfoManager.getInstance();
			...
			forward.setPath("manager_main.jsp");
